...
class PrincipleComponentsBaseSchema(PanderaContainer[pa.DataFrameSchema], ABC):
    def __init__(self):
...
class PrincipleComponentsInputSchema(PrincipleComponentsBaseSchema, DefaultPandasSchemaAcceptor):
    ...
